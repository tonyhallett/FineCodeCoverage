namespace FineCodeCoverageTests.MsCodeCoverage_Tests
{
    ...
    public class RunSettingsTemplate_Tests
    {
        ...
        public void Should_Be_ReplacedTestAdapter_When_Template_Has_The_FCC_TestAdapter_Placeholder()
        {
            var runSettingsTemplate = new RunSettingsTemplate();
            var template = runSettingsTemplate.ToString();
            Assert.That(runSettingsTemplate.ReplaceTemplate(template, new RunSettingsTemplateReplacements(), true).ReplacedTestAdapter, Is.True);
        }
        ...
        public void Should_Be_ReplacedTestAdapter_False_When_Custom_Template_Does_Not_Have_FCC_TestAdapter_Placeholder()
        {
            ...
            Assert.That(runSettingsTemplate.ReplaceTemplate(configuredCustomTemplate, new RunSettingsTemplateReplacements(), true).ReplacedTestAdapter, Is.False);
        }
        ...
        {
            var runSettingsTemplate = new RunSettingsTemplate();
            Assert.That(runSettingsTemplate.HasReplaceableTestAdapter(toReplace), Is.EqualTo(expected));
        }
        ...
        public void Should_Be_FCC_Generated_If_FCCGenerated_Element_Exists()
        {
            ...
            Assert.That(runSettingsTemplate.FCCGenerated(xpathNavigable), Is.True);
        }
        ...
        public void Should_Not_Be_FCC_Generated_If_FCCGenerated_Element_Exists()
        {
            ...
            Assert.That(runSettingsTemplate.FCCGenerated(xpathNavigable), Is.False);
        }
    ...
    public class RunSettingsTemplate_ConfigureCustom_Tests
    {
        ...
        public void Should_Add_Replaceable_RunConfiguration_If_Not_Present()
        {
            ...
            this.ConfiguredCustomReplaceTest(custom, expected, replacements);
        ...
        public void Should_Add_Replaceable_DataCollectionRunSettings_If_Not_Present() =>
            this.AddedReplaceableMsDataCollectorTest("");

        [Test]
        public void Should_Add_Replaceable_DataCollectors_If_Not_Present() =>
            this.AddedReplaceableMsDataCollectorTest("<DataCollectionRunSettings></DataCollectionRunSettings>");

        [Test]
        public void Should_Add_Replaceable_DataCollectors_If_Not_Present_No_End_tag() =>
            this.AddedReplaceableMsDataCollectorTest("<DataCollectionRunSettings/>");


        [Test]
        public void Should_Add_Replaceable_Ms_DataCollector_If_Not_Present() =>
            this.AddedReplaceableMsDataCollectorTest(
                "<DataCollectionRunSettings><DataCollectors></DataCollectors></DataCollectionRunSettings>"
            );
