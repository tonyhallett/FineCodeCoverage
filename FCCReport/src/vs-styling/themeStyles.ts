...
function getVsFocusStyle(vsColors: CategoryColours) {
    return getFocusStyle(null as any, {
        borderColor: "transparent",
        outlineColor: vsColors.CommonControlsColors.FocusVisualText,
    });
}

const overrideHighContrast = (
    themeNotHighContrast: boolean,
    ...propertyNames: Array<keyof CSSProperties>
) => {
    if (themeNotHighContrast) {
        // to type
        const removedProperties: any = {};
        propertyNames.forEach(
            (propertyName) => (removedProperties[propertyName] = false)
        );
...
export function getActionButtonStyles(
    vsColors: CategoryColours,
    themeNotHighContrast: boolean
): DeepPartial<IButtonStyles> {
    const { CommonControlsColors } = vsColors;
    const overrideHighContrastColor = overrideHighContrast(
    ...
    const actionButtonStyles: IButtonStyles = {
        root: [
            getFocusStyle(null as any, {
                inset: 1,
                highContrastStyle: focusHighContrastStyle,
                borderColor: "transparent",
                outlineColor: CommonControlsColors.FocusVisualText,
            }),
            {
...
export function getLinkStyle(
    props: ILinkStyleProps,
    vsColors: CategoryColours,
    themeIsHighContrast: boolean
): DeepPartial<ILinkStyles> {
    const { isDisabled, isButton } = props;
    const { EnvironmentColors: environmentColors, CommonControlsColors } =
        vsColors;
    ...
    return {
        root: [
            {
                ...
                [`:hover .${cbGlobalClassNames.checkmark}`]: {
                    // perhaps should prevent the opacity changing to 1 ?
        ...
        checkmark: {
            color: props.disabled
                ? commonControlsColors.CheckBoxGlyphDisabled
                : commonControlsColors.CheckBoxGlyph,
        },
        text: {
            color: props.disabled
                ? commonControlsColors.CheckBoxTextDisabled
                : commonControlsColors.CheckBoxText,
        },
        input: {
            opacity: 0,
...
export class VsCustomizerContext implements ICustomizerContext {
    ...
    constructor(private styling?: Styling, private zoomFactor = 1) {
        if (styling) {
            ...
            if (newZoomFactor !== 1) {
                (
                    window as any
                ).chrome.webview.hostObjects.webView.setZoomFactor(
                    newZoomFactor
                );
            } else if (this.zoomFactor !== 1) {
                (
                    window as any
                ).chrome.webview.hostObjects.webView.setZoomFactor(1);
            }
            this.zoomFactor = newZoomFactor;
        }
    }

    getNext(styling: Styling) {
        if (styling === this.styling) {
            return this;
        }
        return new VsCustomizerContext(styling, this.zoomFactor);
    }
    ...
    customizations: ICustomizations = {
        scopedSettings: {
            Dropdown: {
                styles: (
                    dropDownStyleProps: IDropdownStyleProps
                ): DeepPartial<IDropdownStyles> => {
                    const { isRenderingPlaceholder, disabled, isOpen } =
                        dropDownStyleProps;
                    const { EnvironmentColors, CommonControlsColors } =
                        this.vsColors;
                    const focusColor = CommonControlsColors.FocusVisualText;
                    const themeIsNotHighContrast =
                        !this.styling!.themeIsHighContrast;
                    const overrideHighContrastBorderColor =
                    ...
                    const overrideHighContrastItemAndTitleStateMixin =
                        overrideHighContrast(
                            themeIsNotHighContrast,
                            "backgroundColor",
                            "borderColor",
                                ...
                                "&:hover:focus": [
                                    {
                                        ...
                                        backgroundColor:
                                            CommonControlsColors.ComboBoxListItemBackgroundHover, //override
                                        borderColor:
                                            CommonControlsColors.ComboBoxListItemBorderHover,
                                    },
                                ...
                                "&:hover": [
                                    {
                                        ...
                                        backgroundColor:
                                            CommonControlsColors.ComboBoxListItemBackgroundHover,
                                        borderColor:
                                            CommonControlsColors.ComboBoxListItemBorderHover,
                                    },
                                    overrideHighContrastColor,
                    ...
                    const dropDownItemHighContrastFocus: any =
                        themeIsNotHighContrast
                            ? {
                                  left: false,
                                  top: false,
                                  ...
                                  right: false,
                                  outlineColor:
                                      this.vsColors.CommonControlsColors
                                          .FocusVisualText,
                              }
                            : {
                                  left: 1,
                    ...
                    const dropDownItemFocusStyle = getFocusStyle(null as any, {
                        inset: 1,
                    ...
                    const dropDownFocusStyle = getFocusStyle(null as any, {
                        borderColor: "transparent",
                        outlineColor:
                            this.vsColors.CommonControlsColors.FocusVisualText,
                        inset: -1,
                    });
                    return {
                        label: {
                        ...
                        dropdown: [
                            {
                                color: isOpen
                                    ? CommonControlsColors.ComboBoxTextPressed
                                    : CommonControlsColors.ComboBoxText,
                                selectors: {
                                    // title --------------------------------------------------------
                                    ["&:hover ." + dropDownClassNames.title]: [
                                        {
                                            color: isOpen
                                                ? CommonControlsColors.ComboBoxTextPressed
                                                : CommonControlsColors.ComboBoxTextHover,
                                            backgroundColor: isOpen
                                                ? CommonControlsColors.ComboBoxBackgroundPressed
                                                : CommonControlsColors.ComboBoxBackgroundHover,
                                            borderColor: isOpen
                                                ? CommonControlsColors.ComboBoxBorderPressed
                                                : CommonControlsColors.ComboBoxBorderHover,
                                        },
                                    ...
                                    ["&:focus ." + dropDownClassNames.title]: [
                                        !disabled && {
                                            ...
                                            borderColor:
                                                CommonControlsColors.ComboBoxBorderFocused,
                                            backgroundColor:
                                                CommonControlsColors.ComboBoxBackgroundFocused,
                                        },
                                        overrideHighContrastColor,
                                    ],
                                    ["&:focus:after"]: [
                                    ...
                                    //caretDown ----------------------------------------------------------------------------------------
                                    [`&:hover .${dropDownClassNames.caretDown}`]:
                                        !disabled && {
                                            color: isOpen
                                                ? CommonControlsColors.ComboBoxGlyphPressed
                                                : CommonControlsColors.ComboBoxGlyphHover,
                                            backgroundColor: isOpen
                                                ? CommonControlsColors.ComboBoxGlyphBackgroundPressed
                                                : CommonControlsColors.ComboBoxGlyphBackgroundHover,
                                            borderColor: isOpen
                                                ? CommonControlsColors.ComboBoxSeparatorPressed
                                                : CommonControlsColors.ComboBoxSeparatorHover,
                                        },
                                    [`&:focus .${dropDownClassNames.caretDown}`]:
                                        [
                                            !disabled && {
                                                ...
                                                backgroundColor:
                                                    CommonControlsColors.ComboBoxGlyphBackgroundFocused,
                                                borderColor:
                                                    CommonControlsColors.ComboBoxSeparatorFocused,
                                            },
                                            overrideHighContrastColor,
                                        ],
                                    ...
                                    [`&:active .${dropDownClassNames.caretDown}`]:
                                        !disabled && {
                            ...
                            ),
                            {
                                selectors: {
                                    [".ms-Callout-main"]: {
                                        ...
                                        backgroundColor:
                                            CommonControlsColors.ComboBoxListBackground,
                        ...
                        title: [
                            {
                                backgroundColor: isOpen
                                    ? CommonControlsColors.ComboBoxBackgroundPressed
                                    : CommonControlsColors.ComboBoxBackground, //override
                                borderColor: isOpen
                                    ? CommonControlsColors.ComboBoxBorderPressed
                                    : CommonControlsColors.ComboBoxBorder, //override
                            },
                            isRenderingPlaceholder && {
                                color: EnvironmentColors.ControlEditHintText,
                            }, //override
                        ],
                        caretDown: {
                            color: isOpen
                                ? CommonControlsColors.ComboBoxGlyphPressed
                                : CommonControlsColors.ComboBoxGlyph,
                            borderLeft: `1px solid ${
                                isOpen
                                    ? CommonControlsColors.ComboBoxSeparatorPressed
                                    : CommonControlsColors.ComboBoxSeparator
                            }`,
                            backgroundColor: isOpen
                                ? CommonControlsColors.ComboBoxGlyphBackgroundPressed
                                : CommonControlsColors.ComboBoxGlyphBackground,
                            paddingLeft: "5px",
                            paddingRight: "5px",
                        },
                        caretDownWrapper: {
                ...
                styles: (): DeepPartial<IModalStyles> => {
                    ...
                    return {
                        main: [
                            {
                                backgroundColor:
                                    EnvironmentColors.ToolWindowBackground,
            ...
            Label: {
                styles: (): DeepPartial<ILabelStyles> => {
                    return {
                        root: {
                            color: this.vsColors.EnvironmentColors
                                .ToolWindowText,
                        },
                    };
                },
            ...
            Link: {
                styles: (
                    linkStyleProps: ILinkStyleProps
                ): DeepPartial<ILinkStyles> => {
                    return getLinkStyle(
                        linkStyleProps,
                        this.vsColors,
            ...
            Checkbox: {
                styles: (
                    checkboxStyleProps: ICheckboxStyleProps
                ): DeepPartial<ICheckboxStyles> => {
                    return vsCbStylesFn(checkboxStyleProps, this.vsColors);
                },
            },
            ProgressIndicator: {
                styles: (
                    progressIndicatorStyleProps: IProgressIndicatorStyleProps
                ): DeepPartial<IProgressIndicatorStyles> => {
                    const {
                    ...
                    const progressBarColor =
                        progressBarColors.IndicatorFill !== trackColor
                            ? progressBarColors.IndicatorFill
                            : environmentColors.ToolWindowText;
                    const themeNotHighContrast =
                        !this.styling?.themeIsHighContrast;
            ...
            Pivot: {
                styles: (
                    pivotStyleProps: IPivotStyleProps
                ): DeepPartial<IPivotStyles> => {
                                ...
                                rootIsTabs && [
                                    {
                                        ...
                                        selectors: {
                                            ...
                                            [`&.is-selected`]: {
                                                ...
                                                backgroundColor:
                                                    environmentColors.ToolWindowTabSelectedTab,
            ...
            Slider: {
                styles: (): DeepPartial<ISliderStyles> => {
                    const { CommonControlsColors, EnvironmentColors } =
                        this.vsColors;
                    const focusStyle = getVsFocusStyle(this.vsColors);

                    const toolWindowTextColor = getColor(
                        EnvironmentColors.ToolWindowText
                    );
                    const toolWindowTextDark = isDark(toolWindowTextColor);
                    const hoverToolWindowTextShade = lightenOrDarken(
                        toolWindowTextColor,
                        0.4,
                        toolWindowTextDark
                    );
                    const hoverToolWindowText = colorRGBA(
                        hoverToolWindowTextShade
                    );
                    const themeNotHighContrast =
                        !this.styling!.themeIsHighContrast;

                    const overrideHighContrastBackgroundColor =
                        overrideHighContrast(
                            themeNotHighContrast,
                            "backgroundColor"
                        );
                                            ...
                                            selectors: {
                                                [HighContrastSelector]: {
                                                    ...(themeNotHighContrast
                                                        ...
                                                        : {
                                                              background:
                                                                  "WindowText", // bizarrely not supplied by base
                                                              border: false as any,
                                                          }),
                                                },
                                            },
            ...
            SearchBox: {
                styles: (
                    searchBoxStyleProps: ISearchBoxStyleProps
                ): DeepPartial<ISearchBoxStyles> => {
                    const { theme, underlined, hasFocus } = searchBoxStyleProps;
                    const { SearchControlColors, CommonControlsColors } =
                        this.vsColors;
                    const themeNotHighContrast =
                        !this.styling?.themeIsHighContrast;
                    ...
                    return {
                        root: [
                            {
                                ...
                                selectors: {
                                    ":hover": {
                                        borderColor:
                                            SearchControlColors.MouseOverBorder,
                                        backgroundColor:
                                            SearchControlColors.MouseOverBackground,
                                    },
                            ...
                            hasFocus && [
                                getInputFocusStyle(
                                    CommonControlsColors.FocusVisualText,
                                    underlined
                                        ? 0
                                ...
                                ),
                                {
                                    ...
                                    backgroundColor:
                                        SearchControlColors.FocusedBackground,
                                },
                                {
                                    selectors: {
                                        ":after": {
                        ...
                        field: [
                            ...
                            hasFocus && {
                                color: SearchControlColors.FocusedBackgroundText,
                            },
                        ],
                        iconContainer: [
                            {
            ...
            SimpleTableRow: {
                styles: (): DeepPartial<IDetailsRowStyles> => {
                    const { EnvironmentColors } = this.vsColors;
                    const environmentCommandBarTextActive =
                        EnvironmentColors.CommandBarTextActive;
                    return {
                        root: [
                            {
                                background: "none",
            ...
            [vsStyledPercentageScope]: {
                styles: (props: {
                    ...
                    const backgroundColor =
                        percentage === null
                            ? "transparent"
                            : EnvironmentColors.VizSurfaceGreenMedium;
                    const themeNotHighContrast =
                        !this.styling!.themeIsHighContrast;
                    return {
                        progressBar: [
            ...
            DetailsHeader: {
                styles: (
                    detailsHeaderStyleProps: IDetailsHeaderStyleProps
                ): DeepPartial<IDetailsHeaderStyles> => {
                                ...
                                selectors: {
                                    ":after": {
                                        ...
                                        background: this
                                            ...
                                            ? HeaderColors.MouseOverText
                                            : EnvironmentColors.CommandBarDragHandle,
                                        opacity: 0,
                                        left: "50%",
                                    },
                                    [`&.is-resizing:after`]: [
            ...
            DetailsColumn: {
                styles: (
                    detailsColumnStyleProps: IDetailsColumnStyleProps
                ): DeepPartial<IDetailsColumnStyles> => {
                    ...
                    return {
                        root: [
                            {
                                color: this.headerColorsForHeaderText
                                    ? HeaderColors.DefaultText
                                    : EnvironmentColors.CommandBarTextActive, // mirroring vs - alt headerColors.DefaultText,
                                background: HeaderColors.Default,
                            ...
                            isActionable && {
                                selectors: {
                                    ":hover": {
                                        color: this.headerColorsForHeaderText
                                            ? HeaderColors.MouseOverText
                                            : EnvironmentColors.CommandBarTextHover, // mirroring vs, alt headerColors.MouseOverText,
                                    ...
                                    ":active": {
                                        color: this.headerColorsForHeaderText
                                            ? HeaderColors.MouseDownText
                                            : EnvironmentColors.CommandBarTextSelected, //mirroring vs, alt headerColors.MouseDownText,
                        ...
                        cellTitle: [getVsFocusStyle(this.vsColors)],
                        nearIcon: {
                            color: HeaderColors.Glyph,
                        },
                        sortIcon: {
            ...
            GroupHeader: {
                styles: (): DeepPartial<IGroupHeaderStyles> => {
                    const { HeaderColors, TreeViewColors, EnvironmentColors } =
                        this.vsColors;
                    const rowBackground = this.rowBackgroundFromTreeViewColors
                        ? TreeViewColors.Background
                        : "transparent";
                    const rowTextColor = this.rowTextFromTreeViewColors
                        ? TreeViewColors.BackgroundText
                        : EnvironmentColors.CommandBarTextActive;
                    const focusStyle = getVsFocusStyle(this.vsColors);
                    return {
                        root: [
            ...
            DetailsRow: {
                styles: (
                    detailsRowStyleProps: IDetailsRowStyleProps
                ): DeepPartial<IDetailsRowStyles> => {
                    ...
                    return {
                        root: [
                            ...
                            isSelected && {
                                ...
                                selectors: {
                                    [`.${progressBarClass}`]: {
                                        backgroundColor:
                                            TreeViewColors.SelectedItemInactiveText,
                                    },
                                    ...
                                    "&:hover": [
                                        {
                                            color: TreeViewColors.SelectedItemInactiveText,
                                            background:
                                                TreeViewColors.SelectedItemInactive,
                                            selectors: {
                                                [".ms-DetailsRow-cell button.ms-Link"]:
                                                    {
                                                        color: TreeViewColors.SelectedItemInactiveText,
                                    ...
                                    "&:focus": [
                                        {
                                            color: TreeViewColors.SelectedItemActiveText,
                                            background:
                                                TreeViewColors.SelectedItemActive,
                                            selectors: {
                                                [`.${progressBarClass}`]: {
                                                    backgroundColor:
                                                        TreeViewColors.SelectedItemActiveText,
                                                },
                                                [`.ms-DetailsRow-cell`]: [
                                                    {
                                                        color: TreeViewColors.SelectedItemActiveText,
                        ...
                        cell: [
                            {
                                selectors: {
                                    "[data-is-focusable='true']": getFocusStyle(
                                        null as any,
                                        {
                                            inset: -1,
                                            borderColor: "cyan",
