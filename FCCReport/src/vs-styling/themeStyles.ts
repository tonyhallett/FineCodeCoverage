...
export class VsCustomizerContext implements ICustomizerContext {
  ...
  constructor(private styling?: Styling, private zoomFactor = 1) {
    if (styling) {
      ...
      if (newZoomFactor !== 1) {
        (window as any).chrome.webview.hostObjects.webView.setZoomFactor(
          newZoomFactor
        );
    ...
    scopedSettings: {
      Dropdown: {
        styles: (
          ...
          const overrideHighContrastBorderColor = overrideHighContrast(
                    ...
                    selectors: {
                      ...
                      [`&.is-selected`]: {
                        ...
                        selectors: {
                          ...
                          "&:active": {
                            color:
                              environmentColors.ToolWindowTabSelectedActiveText,
                            backgroundColor:
                              environmentColors.ToolWindowTabSelectedTab,
                          },
                          ...(themeNotHighContrast
      ...
      Slider: {
        styles: (): DeepPartial<ISliderStyles> => {
          ...
          const overrideHighContrastBackgroundColor = overrideHighContrast(
            themeNotHighContrast,
            "backgroundColor"
          );
          const overrideHighContrastBorderColor = overrideHighContrast(
            ...
            root: [
              ...
              hasFocus && [
                getInputFocusStyle(
                  ...
                  underlined ? 0 : theme.effects.roundedCorner2,
            ...
            cellSizer: [
              {
                selectors: {
                  ":after": {
                    ...
                    bottom: 0,
                    width: 1,
                    background: this.headerColorsForHeaderText
        ...
        styles: (
          ...
          return {
            ...
            cell: [
              {
                selectors: {
                  "[data-is-focusable='true']": getFocusStyle(null as any, {
                    inset: -1,
                    borderColor: "cyan",
                    outlineColor: "pink",
                  }),
