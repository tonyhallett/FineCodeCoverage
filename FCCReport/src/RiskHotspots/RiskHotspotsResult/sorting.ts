...
import { HotspotItem } from "./hotspotItem";
   ...
   // to type
export function stringFieldSort(items:any[], ascending:boolean, fieldName:string):any[]{
...
export function sort(itemsToSort:HotspotItem[],columns:ISortableColumn[],columnSort:ColumnSort | undefined):HotspotItem[]{
