...
export class CoverageItem implements ICoverageItem {
    ...
    constructor(cls: Class, namespacedClasses: boolean, standalone: boolean) {
        ...
        this.name = namespacedClasses
            ? cls.displayName
            : removeNamespaces(cls.displayName);
        ...
        if (this.coverableLines === 0) {
            if (
                cls.coverageType === CoverageType.MethodCoverage &&
                cls.coverageQuota !== null
            ) {
        ...
        this.coveredBranches =
            cls.coveredBranches === null ? 0 : cls.coveredBranches;
    ...
    isFullyCovered(): boolean {
        return (
            this.coverageQuota !== null &&
            this.coverageQuota === 100 &&
            this.branchCoverageQuota !== null &&
            this.branchCoverageQuota === 100
        );
    }
}
