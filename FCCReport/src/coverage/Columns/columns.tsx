...
export const coveredLinesColumn = DataColumn.create("coveredLines",coveredColumnDisplay);
export const coverableLinesColumn = DataColumn.create("coverableLines","Coverable");
export const uncoveredLinesColumn = DataColumn.create("uncoveredLines","Uncovered");
export const totalLinesColumn = DataColumn.create("totalLines",totalColumnDisplay);

export const lineCoverageQuotaColumn = PercentageColumn.create("coverageQuota","Line Coverage");
export const coveredBranchesColumn = DataColumn.create("coveredBranches",coveredColumnDisplay);
export const totalBranchesColumn = DataColumn.create("totalBranches",totalColumnDisplay);
export const branchCoverageQuotaColumn = PercentageColumn.create("branchCoverageQuota","Branch Coverage");
export const coveredCodeElementsColumn = DataColumn.create("coveredCodeElements",coveredColumnDisplay);
export const totalCodeElementsColumn = DataColumn.create("totalCodeElements",totalColumnDisplay);
export const codeElementCoverageQuotaColumn = PercentageColumn.create("codeElementCoverageQuota","Element Coverage");
