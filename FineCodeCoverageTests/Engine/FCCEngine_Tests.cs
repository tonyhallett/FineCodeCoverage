...
namespace FineCodeCoverageTests.Engine
{
    public class FCCEngine_Tests
    {
        ...
        [Test]
        public void Should_ClearUI_When_ClearUI()
        {
            fccEngine.ClearUI();
        ...
        [Test]
        public void Should_ClearUI_When_AppOptions_Change_To_Disabled()
        {
            mocker.GetMock<IAppOptionsProvider>().Raise(args => args.OptionsChanged += null, new AppOptions { Enabled = false });
        ...
        private void VerifyClearsUI()
        {
            mocker.Verify<IEventAggregator>(ea => ea.SendMessage(It.Is<NewCoverageLinesMessage>(msg => msg.CoverageLines == null), null));
            mocker.Verify<IEventAggregator>(ea => ea.SendMessage(It.Is<NewReportMessage>(msg => msg.SummaryResult == null), null));
        }
    }
...
#pragma warning restore VSTHRD110 // Observe result of async calls
        ...
        {
            await ReloadInitializedCoverage_Async();
            mocker.Verify<IReportGeneratorUtil>(rg => rg.Generate
        ...
        public async Task Should_Process_ReportGenerator_Output_If_Success_Raising_Events_Async()
        {
            ...
            var reportGeneratorResult = new ReportGeneratorResult
            {
                ...
                SummaryResult = new SummaryResult(new List<Assembly>().AsReadOnly(),"",true,new List<string>().AsReadOnly()),
            };
            ...
            mocker.Verify<IEventAggregator>(eventAggregator => eventAggregator.SendMessage(
                It.Is<NewReportMessage>(message => message.SummaryResult == reportGeneratorResult.SummaryResult),
                null
                ));
